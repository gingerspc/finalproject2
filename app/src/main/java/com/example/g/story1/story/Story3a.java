...
public class Story3a extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStory.setText("I found a gun under the register");
        button1.setText("Shoot him.");
        button2.setText("Give him the money");

        button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Story3a.this, End1.class));
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Story3a.this, End2.class));
