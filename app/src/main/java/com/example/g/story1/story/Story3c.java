...
public class Story3c extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStory.setText("I found a gun in the backroom.");
        button1.setText("Shoot him");
        button2.setText("Call 911");

        button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Story3c.this, End1.class));
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Story3c.this, End2.class));
